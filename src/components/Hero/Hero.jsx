  ...
  return (
    <section className={styles.container}>
        <div className={styles.content}>
            ...
            <p className={styles.description}>Passionate IT Engineering student from VIIT,Pune with good programming skills . Constantly seeking new knowledge and experiences, I stay updated with the latest trends.</p>
