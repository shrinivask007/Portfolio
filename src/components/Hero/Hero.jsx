    ...
    <section className={styles.container}>
      <div className={styles.content}>
        ...
        <div className={styles.heroAction}>
          <a href="mailto:shrinivassk18@gmail.com" target="new" className={styles.contactBtn}>Contact Me</a>
          <a href="https://drive.google.com/file/d/1-oIYNgid5XAMD-Uhljm5BA7ats-Lqjq6/view?usp=sharing" target="new" className={styles.contactBtn}>My Resume</a>
        </div>
       ...
       <a href="https://fb.com/shrinivas.kathare.007" target="blank"><img align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/facebook.svg" alt="hriniva.kathare.5" height="30" width="40" /></a>
       </div>
      </div>
